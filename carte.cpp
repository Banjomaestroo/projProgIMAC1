...
void Carte :: generatePokimacs(){
	...
	pokimac.push_back(Pokimac("Soulakmeche", "soulakmeche","Oz", "Je crois que c'est un genre de prof, mais c'est à vérifier. Sa voix et son énergie dévastatrice m'ont traumatisé dès le premier jour",10,40,50,0,"fire"));

	pokimac.push_back(Pokimac("Grobillzard", "grobizard","Gaga", "Qu'est ce le covid? Écoutez je ne pense pas qu'il y ait de bonnes ou de mauvaises folies",15,20,60,100, "plant"));	

	pokimac.push_back( Pokimac("BouffeDuChou", "pika","Miam", "C'est un rat. Il me fait penser à quelqu'un ... En tout cas pikachu il est chou, et toi t'es moche.",10,25,20,70,"lightning"));	  

	pokimac.push_back( Pokimac("CaraMousse", "pouce","CaraPoucePlusFort", "Confiné, confiné, mais pas con fini. Du moins je crois pas, j'espere pas, du moins pas encore...",18,18,40,60,"water"));	  

	pokimac.push_back( Pokimac("Papicha", "papillon", "YonPiPa", "Je crois pas en ... non pour moi ça ne peut pas exister, mais après libre à vous d'avoir tort.",12,20,78,20,"plant"));

	pokimac.push_back( Pokimac("GrasDouble", "doudou", "Grobese", "Moi aussi je suis à la recherche d'un doudou, veuillez laisser un cv à l'adresse suivante.", 40,80,20,10,"psy"));
	...
	pokimac.push_back( Pokimac("Vava", "vapor", "FéCho", "Vive le réchauffement climatique, dans ta face Greta", 35, 70, 30,10, "fire"));
